...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mix_match'
        db.create_table(u'mix_match_mix_match', (
            ...
            ('unit_discount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
        ))
        db.send_create_signal(u'mix_match', ['Mix_match'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Mix_match'
        db.delete_table(u'mix_match_mix_match')
    ...
    models = {
        ...
        u'mix_match.mix_match': {
            ...
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['store.Store']"}),
            'unit_discount': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'})
        },
        u'mix_match.mix_match_child': {
            'Meta': {'unique_together': "(('parent', 'store_product'),)", 'object_name': 'Mix_match_child'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mix_match.Mix_match']"}),

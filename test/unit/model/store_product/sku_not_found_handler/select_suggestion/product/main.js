describe('model.store_product.sku_not_found_handler.select_suggestion.product',function(){
    ...
    beforeEach(inject(function($injector){
        createService = function(){
            return $injector.get('model.store_product.sku_not_found_handler.select_product');
        }
    }));
    ...
    it('can open modal with correct template',inject(function($templateCache){
        ...
        expect(arg.template).toEqual($templateCache.get('model.store_product.sku_not_found_handler.select_suggestion.product.main.html'))
    }));

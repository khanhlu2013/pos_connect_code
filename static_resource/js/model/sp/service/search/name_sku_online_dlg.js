...
{
    var mod = angular.module('sp/service/search/name_sku_online_dlg',
    [
         'directive/share_directive'
        ,'sp/api_search'
        ,'service/misc'
    ...
    mod.factory('sp/service/search/name_sku_online_dlg/multiple',
    [
         '$modal'
        ,'sp/api_search'
        ,'service/misc'
    ...
    mod.factory('sp/service/search/name_sku_online_dlg/single',
    [
         '$modal'
        ,'sp/api_search'
        ,'service/ui/alert'

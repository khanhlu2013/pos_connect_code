...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'receipt.receipt_ln': {
            ...
            'non_inventory': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['store_product.Non_inventory']", 'null': 'True', 'blank': 'True'}),
        ...
        u'store_product.non_inventory': {
            'Meta': {'object_name': 'Non_inventory'},

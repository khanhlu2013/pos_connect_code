...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store_product.sp_doc_id'
        db.add_column(u'store_product_store_product', 'sp_doc_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store_product.sp_doc_id'
        db.delete_column(u'store_product_store_product', 'sp_doc_id')

...
(
    ...
    {
        describe("ds modifier's compressor (when update price) ",function(){
            //DB SETUP
            ...
            beforeEach(function () {
                ...
                runs(function () {
                    ...
                    var instruction_1 = new Instruction(false/*not_delete*/,1/*new_qty*/,top_price/*new_price*/,null/*new_discount*/);
                    var instruction_2 = new Instruction(false/*not_delete*/,1/*new_qty*/,sandwich_price/*new_price*/,null/*new_discount*/);
                    var instruction_3 = new Instruction(false/*not_delete*/,1/*new_qty*/,bottom_price/*new_price*/,null/*new_discount*/);
            ...
            it('can update TOP and NOT compressed', function () {
                ...
                runs(function () {
                    ...
                    var new_price = 4;//NOT compressed

                    
                    var instruction = new Instruction(false/*not_delete*/,1/*new_qty*/,new_price,null/*new_discount*/);
            ...
            it('can update SANDWICH and DO compressed ONLY TOP', function () {
                ...
                runs(function () {
                    var modifiying_index = sandwich_index;
                    var new_price = 1;//DO compressed ONLY TOP
            ...
            it('can update SANDWICH and DO compressed ONLY BOTTOM', function () {
                ...
                runs(function () {
                    var modifiying_index = sandwich_index;
                    var new_price = 3;//DO compressed ONLY BOTTOM
            ...
            it('can update SANDWICH and DO compressed BOTH', function () {
                ...
                runs(function () {
                    var modifiying_index = sandwich_index;
                    var new_price = 1;//DO compressed BOTH

                    //this is a special case we need to make top and bottom item the same price for sandwich item to combine both

                    var test_setup_botom_price = 1;
                    var test_setup_instruction = new Instruction(false/*not_delete*/,1/*new_qty*/,test_setup_botom_price,null/*new_discount*/);
                ...
                waitsFor(function() {
                    return (final_ps_lst !== null);
                }, "modification", time_out);

...
{
    var mod = angular.module('sp_app/service/api_sku',['sp_app/model']);
    mod.factory('sp_app/service/api_sku',['$http','$q','sp_app/model/Store_product',function($http,$q,Store_product){
    	return{

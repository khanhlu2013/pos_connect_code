...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment_type.sort'
        db.add_column(u'payment_type_payment_type', 'sort',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment_type.sort'
        db.delete_column(u'payment_type_payment_type', 'sort')

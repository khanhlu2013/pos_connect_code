...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receipt_ln.store_product'
        db.alter_column(u'sale_receipt_ln', 'store_product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store_product.Store_product'], null=True))

    def backwards(self, orm):

        # Changing field 'Receipt_ln.store_product'
        db.alter_column(u'sale_receipt_ln', 'store_product_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['store_product.Store_product']))

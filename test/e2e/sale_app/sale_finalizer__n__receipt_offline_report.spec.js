    ...
    it('can display receipt summary',function(){
        ...
        */
        ...
        ptor.wait(function(){
            ...
            function(){
                expect(element(by.id('receipt_app/service/report/receipt_summary/tender/null')).getText()).toEqual('($10.00)');        
                expect(element(by.id('receipt_app/service/report/receipt_summary/tender/' + pt_lst_from_server[0].id)).getText()).toEqual('($20.00)');        
                expect(element(by.id('receipt_app/service/report/receipt_summary/tender/' + pt_lst_from_server[1].id)).getText()).toEqual('($30.00)');       
            }
        )          

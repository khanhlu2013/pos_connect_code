...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product._old_id'
        db.alter_column(u'product_product', '_old_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Sku._old_id'
        db.alter_column(u'product_sku', '_old_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Unit._old_id'
        db.alter_column(u'product_unit', '_old_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Product._old_id'
        db.alter_column(u'product_product', '_old_id', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Sku._old_id'
        db.alter_column(u'product_sku', '_old_id', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Unit._old_id'
        db.alter_column(u'product_unit', '_old_id', self.gf('django.db.models.fields.IntegerField')(default=None))

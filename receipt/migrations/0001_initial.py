...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'receipt_receipt', (
        ...
        # Adding model 'Tender_ln'
        db.create_table(u'receipt_tender_ln', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receipt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['receipt.Receipt'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'receipt', ['Tender_ln'])

        # Adding model 'Receipt_ln'
        db.create_table(u'receipt_receipt_ln', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receipt', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['receipt.Receipt'])),
        ...
        db.send_create_signal(u'receipt', ['Receipt_ln'])


    def backwards(self, orm):
        # Deleting model 'Receipt'
        db.delete_table(u'receipt_receipt')

        # Deleting model 'Tender_ln'
        db.delete_table(u'receipt_tender_ln')

        # Deleting model 'Receipt_ln'
        db.delete_table(u'receipt_receipt_ln')

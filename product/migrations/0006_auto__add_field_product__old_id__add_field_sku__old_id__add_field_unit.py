...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product._old_id'
        db.add_column(u'product_product', '_old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Adding field 'Sku._old_id'
        db.add_column(u'product_sku', '_old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Adding field 'Unit._old_id'
        db.add_column(u'product_unit', '_old_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product._old_id'
        db.delete_column(u'product_product', '_old_id')

        # Deleting field 'Sku._old_id'
        db.delete_column(u'product_sku', '_old_id')

        # Deleting field 'Unit._old_id'
        db.delete_column(u'product_unit', '_old_id')
    ...
    models = {
        ...
        u'product.product': {
            ...
            '_old_id': ('django.db.models.fields.IntegerField', [], {}),

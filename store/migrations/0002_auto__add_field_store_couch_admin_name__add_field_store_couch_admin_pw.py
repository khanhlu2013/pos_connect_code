...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.couch_admin_name'
        db.add_column(u'store_store', 'couch_admin_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Store.couch_admin_pwrd'
        db.add_column(u'store_store', 'couch_admin_pwrd',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Store.couch_url'
        db.add_column(u'store_store', 'couch_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.couch_admin_name'
        db.delete_column(u'store_store', 'couch_admin_name')

        # Deleting field 'Store.couch_admin_pwrd'
        db.delete_column(u'store_store', 'couch_admin_pwrd')

        # Deleting field 'Store.couch_url'
        db.delete_column(u'store_store', 'couch_url')
    ...
    models = {
        ...
        u'store.store': {
            ...
            'couch_admin_name': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'couch_admin_pwrd': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'couch_url': ('django.db.models.fields.CharField', [], {'max_length': '25'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.api_key_name'
        db.add_column(u'store_store', 'api_key_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=25),
                      keep_default=False)

        # Adding field 'Store.api_key_pwrd'
        db.add_column(u'store_store', 'api_key_pwrd',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.api_key_name'
        db.delete_column(u'store_store', 'api_key_name')

        # Deleting field 'Store.api_key_pwrd'
        db.delete_column(u'store_store', 'api_key_pwrd')
    ...
    models = {
        ...
        u'store.store': {
            ...
            'api_key_name': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'api_key_pwrd': ('django.db.models.fields.CharField', [], {'max_length': '25'}),

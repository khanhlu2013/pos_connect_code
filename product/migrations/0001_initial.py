...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'product_unit', (
            ...
            ('_old_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        ...
        db.create_table(u'product_prodskuassoc', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bus.Business'], null=True, blank=True)),
            ('is_approve_override', self.gf('django.db.models.fields.BooleanField')()),
        ))
        ...
        db.create_table(u'product_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_name_admin', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('_size_admin', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('_unit_admin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Unit'], null=True, blank=True)),

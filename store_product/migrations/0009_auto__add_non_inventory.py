...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Non_inventory'
        db.create_table(u'store_product_non_inventory', (
        ...
        db.send_create_signal(u'store_product', ['Non_inventory'])


    def backwards(self, orm):
        # Deleting model 'Non_inventory'
        db.delete_table(u'store_product_non_inventory')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field report_lst on 'Store_product'
        m2m_table_name = db.shorten_name(u'store_product_store_product_report_lst')
        ...
        db.create_unique(m2m_table_name, ['store_product_id', 'report_id'])


    def backwards(self, orm):
        # Removing M2M table for field report_lst on 'Store_product'
        db.delete_table(db.shorten_name(u'store_product_store_product_report_lst'))
    ...
    models = {
        ...
        u'store_product.store_product': {
            ...
            'cur_stock': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['product.Product']"}),
            'report_lst': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'sp_lst'", 'symmetrical': 'False', 'to': u"orm['report.Report']"}),

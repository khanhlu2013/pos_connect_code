...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receipt._doc_id_creator'
        db.add_column(u'sale_receipt', '_doc_id_creator',
                      self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receipt._doc_id_creator'
        db.delete_column(u'sale_receipt', '_doc_id_creator')

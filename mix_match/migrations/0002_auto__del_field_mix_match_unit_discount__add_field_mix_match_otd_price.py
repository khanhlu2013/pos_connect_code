...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mix_match.unit_discount'
        db.delete_column(u'mix_match_mix_match', 'unit_discount')

        # Adding field 'Mix_match.otd_price'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Mix_match.unit_discount'
        raise RuntimeError("Cannot reverse this migration. 'Mix_match.unit_discount' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Mix_match.unit_discount'
        db.add_column(u'mix_match_mix_match', 'unit_discount',
    ...
    models = {
        ...
        u'mix_match.mix_match': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'otd_price': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),

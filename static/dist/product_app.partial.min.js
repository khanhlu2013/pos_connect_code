...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('model.product.network_product.main.html',
    '<div ng-hide="network_product === undefined || network_product === null">\n' +
    '    <div class="col-md-6">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('model.store_product.sku_not_found_handler.select_suggestion.confirm.main.html',
    '<div \n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('model.store_product.sku_not_found_handler.select_suggestion.product.main.html',
    '<div \n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('model.store_product.sku_not_found_handler.select_suggestion.store_product.main.html',

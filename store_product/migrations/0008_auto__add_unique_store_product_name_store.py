...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Store_product', fields ['name', 'store']
        db.create_unique(u'store_product_store_product', ['name', 'store_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Store_product', fields ['name', 'store']
        db.delete_unique(u'store_product_store_product', ['name', 'store_id'])

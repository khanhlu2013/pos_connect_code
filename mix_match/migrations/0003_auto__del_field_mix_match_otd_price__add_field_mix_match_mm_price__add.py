...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mix_match.otd_price'
        db.delete_column(u'mix_match_mix_match', 'otd_price')

        # Adding field 'Mix_match.mm_price'
        db.add_column(u'mix_match_mix_match', 'mm_price',
                      self.gf('django.db.models.fields.DecimalField')(default=9999, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Mix_match.is_include_crv_tax'
        db.add_column(u'mix_match_mix_match', 'is_include_crv_tax',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Mix_match.otd_price'
        raise RuntimeError("Cannot reverse this migration. 'Mix_match.otd_price' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Mix_match.otd_price'
        db.add_column(u'mix_match_mix_match', 'otd_price',
                      self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Mix_match.mm_price'
        db.delete_column(u'mix_match_mix_match', 'mm_price')

        # Deleting field 'Mix_match.is_include_crv_tax'
        db.delete_column(u'mix_match_mix_match', 'is_include_crv_tax')

...
var Prompt_dlg = function () {
    ...
    //btn
    this.add_btn = element(by.id('report_app/service/prompt/add_btn'));
    this.ok_btn = element(by.id('report_app/service/prompt/ok_btn'));
    this.cancel_btn = element(by.id('report_app/service/prompt/cancel_btn'));

    //txt
    this.name_txt = element(by.id('report_app/service/prompt/name_txt'));

    //table
    this.lst = element.all(by.repeater('sp in report.sp_lst'));

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'store_product_store_product', (
            ...
            ('is_sale_report', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        # Adding unique constraint on 'Store_product', fields ['product', 'store']
        db.create_unique(u'store_product_store_product', ['product_id', 'store_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Store_product', fields ['product', 'store']
        db.delete_unique(u'store_product_store_product', ['product_id', 'store_id'])

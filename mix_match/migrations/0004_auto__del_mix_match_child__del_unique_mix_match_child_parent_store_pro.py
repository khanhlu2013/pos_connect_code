...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Mix_match_child', fields ['parent', 'store_product']
        db.delete_unique(u'mix_match_mix_match_child', ['parent_id', 'store_product_id'])

        # Deleting model 'Mix_match_child'
        db.delete_table(u'mix_match_mix_match_child')

        # Adding M2M table for field sp_lst on 'Mix_match'
        m2m_table_name = db.shorten_name(u'mix_match_mix_match_sp_lst')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mix_match', models.ForeignKey(orm[u'mix_match.mix_match'], null=False)),
            ('store_product', models.ForeignKey(orm[u'store_product.store_product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mix_match_id', 'store_product_id'])


    def backwards(self, orm):
        # Adding model 'Mix_match_child'
        db.create_table(u'mix_match_mix_match_child', (
            ('store_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store_product.Store_product'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mix_match.Mix_match'])),
        ))
        db.send_create_signal(u'mix_match', ['Mix_match_child'])

        # Adding unique constraint on 'Mix_match_child', fields ['parent', 'store_product']
        db.create_unique(u'mix_match_mix_match_child', ['parent_id', 'store_product_id'])

        # Removing M2M table for field sp_lst on 'Mix_match'
        db.delete_table(db.shorten_name(u'mix_match_mix_match_sp_lst'))
    ...
    models = {
        ...
        u'mix_match.mix_match': {
            'Meta': {'object_name': 'Mix_match'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_include_crv_tax': ('django.db.models.fields.BooleanField', [], {}),
            'mm_price': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'qty': ('django.db.models.fields.IntegerField', [], {}),
            'sp_lst': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['store_product.Store_product']", 'symmetrical': 'False'}),
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['store.Store']"})
        },
        ...
        u'store_product.store_product': {
            ...
            'group_set': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'store_product_set'", 'symmetrical': 'False', 'to': u"orm['group.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

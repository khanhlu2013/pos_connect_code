...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store_product.p_type'
        db.add_column(u'store_product_store_product', 'p_type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store_product.p_tag'
        db.add_column(u'store_product_store_product', 'p_tag',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store_product.p_type'
        db.delete_column(u'store_product_store_product', 'p_type')

        # Deleting field 'Store_product.p_tag'
        db.delete_column(u'store_product_store_product', 'p_tag')

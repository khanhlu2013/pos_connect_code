...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.is_profit_information_exchange'
        db.add_column(u'store_store', 'is_profit_information_exchange',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.is_profit_information_exchange'
        db.delete_column(u'store_store', 'is_profit_information_exchange')
    ...
    models = {
        ...
        u'store.store': {
            ...
            'is_profit_information_exchange': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

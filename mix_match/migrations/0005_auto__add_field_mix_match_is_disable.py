...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mix_match.is_disable'
        db.add_column(u'mix_match_mix_match', 'is_disable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mix_match.is_disable'
        db.delete_column(u'mix_match_mix_match', 'is_disable')
    ...
    models = {
        ...
        u'mix_match.mix_match': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_disable': ('django.db.models.fields.BooleanField', [], {}),

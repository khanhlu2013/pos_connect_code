define(['lib/number/number'],function(number){
    ...
    Displaying_scan.prototype = {
        ...
        ,get_total_discount_price: function () {
            var result = this.price - this.get_total_discount();
            return number.round_2_decimal(result);
        }
        ,get_crv: function(){
            var result = 0.0;
        ...
        ,get_otd_wot_price: function(){
            var result = this.get_total_discount_price() + this.get_crv();
            return number.round_2_decimal(result);
        }
        ...
        ,get_otd_wt_price: function(tax_rate){
            var result =  this.get_otd_wot_price() + this.get_tax(tax_rate) + this.get_buydown_tax(tax_rate);
            return number.round_2_decimal(result);
        }

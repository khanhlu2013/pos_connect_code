...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receipt_ln.sp_stamp_is_sale_report'
        db.add_column(u'receipt_receipt_ln', 'sp_stamp_is_sale_report',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receipt_ln.sp_stamp_is_sale_report'
        db.delete_column(u'receipt_receipt_ln', 'sp_stamp_is_sale_report')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store_product.value_customer_price'
        db.add_column(u'store_product_store_product', 'value_customer_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store_product.value_customer_price'
        db.delete_column(u'store_product_store_product', 'value_customer_price')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Store_product.department'
        db.delete_column(u'store_product_store_product', 'department_id')


    def backwards(self, orm):
        # Adding field 'Store_product.department'
        db.add_column(u'store_product_store_product', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Department'], null=True, blank=True),
                      keep_default=False)

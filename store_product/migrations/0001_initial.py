...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Store_product'
        db.create_table(u'store_product_store_product', (
            ...
            ('crv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3, blank=True)),
            ('isTaxable', self.gf('django.db.models.fields.BooleanField')()),
            ('isTaxReport', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('isSaleReport', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Department'], null=True, blank=True)),
        ))
        db.send_create_signal(u'store_product', ['Store_product'])

        # Adding unique constraint on 'Store_product', fields ['product', 'business']
        db.create_unique(u'store_product_store_product', ['product_id', 'business_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Store_product', fields ['product', 'business']
        db.delete_unique(u'store_product_store_product', ['product_id', 'business_id'])

        # Deleting model 'Store_product'
        db.delete_table(u'store_product_store_product')

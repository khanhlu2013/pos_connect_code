...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receipt.time_stamp'
        db.alter_column(u'sale_receipt', 'time_stamp', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Receipt.time_stamp'
        db.alter_column(u'sale_receipt', 'time_stamp', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'sale.receipt': {
            ...
            '_doc_id_creator': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
            ...
            'time_stamp': ('django.db.models.fields.BigIntegerField', [], {})
        },
        u'sale.receipt_ln': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'none_product_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store_product.cur_stock'
        db.add_column(u'store_product_store_product', 'cur_stock',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store_product.cur_stock'
        db.delete_column(u'store_product_store_product', 'cur_stock')

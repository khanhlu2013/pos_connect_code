...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Parent', fields ['store', 'position']
        db.create_unique(u'sale_shortcut_parent', ['store_id', 'position'])
        ...
        # Adding unique constraint on 'Child', fields ['parent', 'position']
        db.create_unique(u'sale_shortcut_child', ['parent_id', 'position'])


    def backwards(self, orm):
        # Removing unique constraint on 'Child', fields ['parent', 'position']
        db.delete_unique(u'sale_shortcut_child', ['parent_id', 'position'])

        # Removing unique constraint on 'Parent', fields ['store', 'position']
        db.delete_unique(u'sale_shortcut_parent', ['store_id', 'position'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProdSkuAssoc.is_approved'
        db.delete_column(u'product_prodskuassoc', 'is_approved')

        # Adding field 'ProdSkuAssoc.is_approve_override'
        db.add_column(u'product_prodskuassoc', 'is_approve_override',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProdSkuAssoc.is_approved'
        db.add_column(u'product_prodskuassoc', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ProdSkuAssoc.is_approve_override'
        db.delete_column(u'product_prodskuassoc', 'is_approve_override')

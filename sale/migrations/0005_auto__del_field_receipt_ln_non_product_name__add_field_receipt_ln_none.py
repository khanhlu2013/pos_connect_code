...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receipt_ln.none_product_name'
        db.add_column(u'sale_receipt_ln', 'none_product_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Receipt_ln.none_product_name'
        db.delete_column(u'sale_receipt_ln', 'none_product_name')

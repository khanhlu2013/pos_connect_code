...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'store_store', (
            (u'business_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bus.Business'], unique=True, primary_key=True)),
            ('tax_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
            ('api_key_name', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('api_key_pwrd', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
        ))

...
var Prompt_dlg = function () {
    ...
    //btn
    this.remove_sp_btn = element(by.id('shortcut_app/service/prompt/remove_sp_btn'));
    ...
    //lbl
    this.non_inventory_warning_lbl = element(by.id('shortcut_app/service/prompt/non_inventory_warning_lbl'));
    ...
    //function btn
    this.remove_sp = function(){ lib.click(this.remove_sp_btn); }

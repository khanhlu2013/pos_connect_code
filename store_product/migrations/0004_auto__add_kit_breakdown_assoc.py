...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Kit_breakdown_assoc'
        db.create_table(u'store_product_kit_breakdown_assoc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='kit_assoc_set', to=orm['store_product.Store_product'])),
            ('breakdown', self.gf('django.db.models.fields.related.ForeignKey')(related_name='breakdown_assoc_set', to=orm['store_product.Store_product'])),
            ('qty', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'store_product', ['Kit_breakdown_assoc'])

        # Removing M2M table for field kit_child_set on 'Store_product'
        db.delete_table(db.shorten_name(u'store_product_store_product_kit_child_set'))


    def backwards(self, orm):
        # Deleting model 'Kit_breakdown_assoc'
        db.delete_table(u'store_product_kit_breakdown_assoc')

        # Adding M2M table for field kit_child_set on 'Store_product'
        m2m_table_name = db.shorten_name(u'store_product_store_product_kit_child_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_store_product', models.ForeignKey(orm[u'store_product.store_product'], null=False)),
            ('to_store_product', models.ForeignKey(orm[u'store_product.store_product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_store_product_id', 'to_store_product_id'])
    ...
    models = {
        ...
        u'store_product.kit_breakdown_assoc': {
            ...
            'breakdown': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'breakdown_assoc_set'", 'to': u"orm['store_product.Store_product']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'kit_assoc_set'", 'to': u"orm['store_product.Store_product']"}),
        ...
        u'store_product.store_product': {
            ...
            'breakdown_set': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'kit_set'", 'symmetrical': 'False', 'through': u"orm['store_product.Kit_breakdown_assoc']", 'to': u"orm['store_product.Store_product']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment_type.active'
        db.add_column(u'payment_type_payment_type', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment_type.active'
        db.delete_column(u'payment_type_payment_type', 'active')

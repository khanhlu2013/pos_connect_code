...
{
    //PRODUCT APP MODEL
    var mod = angular.module('product/model',
    [
        'service/misc'
    ]);

    //Product
    mod.factory('product/model/Product',
    [
    ...
    ,function(
    	...
    	Product.build = function(raw_json){
            Store_product = $injector.get('sp/model/Store_product');
            var sp_lst = null;
    ...
    //Prod_sku_assoc
    mod.factory('product/model/Prod_sku_assoc',[function(){

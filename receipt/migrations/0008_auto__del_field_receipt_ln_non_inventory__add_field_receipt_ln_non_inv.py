...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Receipt_ln.non_inventory'
        db.delete_column(u'receipt_receipt_ln', 'non_inventory_id')
        ...
        # Adding field 'Receipt_ln.non_inventory_crv'
        db.add_column(u'receipt_receipt_ln', 'non_inventory_crv',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Receipt_ln.non_inventory_is_taxable'
        db.add_column(u'receipt_receipt_ln', 'non_inventory_is_taxable',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Receipt_ln.non_inventory_cost'
        db.add_column(u'receipt_receipt_ln', 'non_inventory_cost',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Receipt_ln.non_inventory'
        db.add_column(u'receipt_receipt_ln', 'non_inventory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store_product.Non_inventory'], null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Receipt_ln.non_inventory_crv'
        db.delete_column(u'receipt_receipt_ln', 'non_inventory_crv')

        # Deleting field 'Receipt_ln.non_inventory_is_taxable'
        db.delete_column(u'receipt_receipt_ln', 'non_inventory_is_taxable')

        # Deleting field 'Receipt_ln.non_inventory_cost'
        db.delete_column(u'receipt_receipt_ln', 'non_inventory_cost')
    ...
    models = {
        ...
        u'receipt.receipt_ln': {
            ...
            'non_inventory_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'non_inventory_crv': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'non_inventory_is_taxable': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'receipt': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'receipt_ln_lst'", 'to': u"orm['receipt.Receipt']"}),
            ...
            'sp_stamp_is_sale_report': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'receipt.tender_ln': {
            ...
            'receipt': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tender_ln_lst'", 'to': u"orm['receipt.Receipt']"})
        },
        u'store.store': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.couch_admin_pwrd'
        db.alter_column(u'store_store', 'couch_admin_pwrd', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Store.couch_admin_name'
        db.alter_column(u'store_store', 'couch_admin_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Store.couch_url'
        db.alter_column(u'store_store', 'couch_url', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Store.couch_admin_pwrd'
        db.alter_column(u'store_store', 'couch_admin_pwrd', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Store.couch_admin_name'
        db.alter_column(u'store_store', 'couch_admin_name', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Store.couch_url'
        db.alter_column(u'store_store', 'couch_url', self.gf('django.db.models.fields.CharField')(max_length=25))

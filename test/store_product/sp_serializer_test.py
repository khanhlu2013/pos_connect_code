...
class test(WebTest):   
    ...
    def test(self):
        ...
        self.assertEqual(sp_serialized['price'],Decimal(str(price)))
        self.assertEqual(sp_serialized['crv'],Decimal(str(crv)))
        ...
        self.assertEqual(sp_serialized['cost'],Decimal(str(cost)))
        self.assertEqual(sp_serialized['vendor'],vendor)
        self.assertEqual(sp_serialized['buydown'],Decimal(str(buydown)))        

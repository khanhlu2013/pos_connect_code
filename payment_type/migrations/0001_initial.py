...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Payment_type'
        db.create_table(u'payment_type_payment_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Store'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'payment_type', ['Payment_type'])


    def backwards(self, orm):
        # Deleting model 'Payment_type'
        db.delete_table(u'payment_type_payment_type')

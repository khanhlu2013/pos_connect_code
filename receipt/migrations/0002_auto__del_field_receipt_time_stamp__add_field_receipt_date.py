...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Receipt.time_stamp'
        db.delete_column(u'receipt_receipt', 'time_stamp')

        # Adding field 'Receipt.date'
        db.add_column(u'receipt_receipt', 'date',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Receipt.time_stamp'
        raise RuntimeError("Cannot reverse this migration. 'Receipt.time_stamp' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Receipt.time_stamp'
        db.add_column(u'receipt_receipt', 'time_stamp',
                      self.gf('django.db.models.fields.DateTimeField')(),
                      keep_default=False)

        # Deleting field 'Receipt.date'
        db.delete_column(u'receipt_receipt', 'date')

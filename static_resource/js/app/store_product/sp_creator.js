    ...
    )
{
    ...
    function select_option(prodStore_prodSku_1_0,prodStore_prodSku_0_0,store_id,callback){
        if(prodStore_prodSku_1_0.length == 0 && prodStore_prodSku_0_0.length == 0){
            ...
            var html_str = 
                '<div id="select_product_option_dialog">' +
                    '<input type="button" id = "product_option_create_new_btn" value = "create new product">' +
                    '<table id="select_product_option_tbl" border="1"></table>' +
                '</div>';
            ...
            $(html_str).appendTo('body')
                ...
                {
                    modal: true,
                    title : 'create new or select old product',
                    zIndex: 10000,
                    autoOpen: true,
                    width: 700,
                    height: 600,
                    ...
                    open: function( event, ui ) 
                    {
                        ...
                        $('#product_option_create_new_btn').click(function(){
                            callback(null,null);
                            $("#select_product_option_dialog").dialog("close");
                        });
        ...
        if(prodStore_prodSku_1_1.length != 0){
            ...
            async.waterfall([select_option_b],function(error,result){
                ...
                if(selected_product != null && product_json_helper.get_p_from_lst(selected_product.product_id,prodStore_prodSku_1_0) ) {
                    ...
                    var sku_adder_b = sku_adder.bind(sku_adder,selected_product.product_id,sku_str,couch_server_url,store_id);
